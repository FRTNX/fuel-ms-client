    ...
    <div style={{}}>
      ...
      <div style={{ position: 'relative', display: 'flex', width: '100%', textAlign: 'center', justifyContent: 'center' }}>
        ...
        >
          <div>
            <p>Are you sure?</p>
            <p style={{ fontSize: 13, color: 'grey' }}>This will permanently delete this vehicle from this universe. You'll have to hop on to an alternate timeline to find it again, if you believe in miltiverse theory, that is.</p>
          </div>
          <div style={{}}>
